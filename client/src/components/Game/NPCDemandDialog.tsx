...
export const NPCDemandDialog: React.FC<NPCDemandDialogProps> = ({ npc, onResponse }) => {
  ...
  return (
    <Dialog open={true} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-md bg-[#1a1a1a] border-[#ef4444] border-2 shadow-[0_0_20px_rgba(239,68,68,0.3)]">
        <DialogHeader className="space-y-3">
          ...
          <DialogTitle className="text-2xl font-bold text-center text-white uppercase tracking-tighter">
        ...
        <div className="bg-black/40 border border-zinc-800 rounded-lg p-6 my-4 italic text-zinc-200 text-lg text-center leading-relaxed">
          "Drop everything you've got right now, and maybe I'll let you walk away with your life. Don't make this difficult."
        </div>

        <div className="grid grid-cols-1 gap-4 text-sm text-zinc-500 px-2">
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-3 pt-4">
          <Button 
            variant="outline"
            className="flex-1 bg-transparent border-zinc-700 text-zinc-300 hover:bg-zinc-800 hover:text-white h-12 font-bold transition-all group"
