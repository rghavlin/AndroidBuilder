            ...
            >
                {displayLogs.length === 0 ? (
                    ...
                    displayLogs.map((log) => (
                        ...
                        >
                            <span className={cn("font-mono mr-1.5 shrink-0", isLightTheme(theme) ? "text-zinc-500" : "opacity-40")}>[{log.timestamp}]</span>
                            <span className={cn("font-bold uppercase mr-1.5 text-[9px] shrink-0", isLightTheme(theme) ? "opacity-90" : "opacity-60")}>{log.type}</span>
