...
const CompactSkillRow = ({ title, level, progressLabel, current, next, prev, metrics }: CompactSkillRowProps) => {
    return (
        <div className="bg-card/35 p-2 rounded-lg border border-border/40 hover:border-primary/20 transition-all duration-300 hover:bg-card/50">
            ...
            <div className="flex justify-between items-center mb-1 gap-2">
                <div className="flex items-center gap-1.5 min-w-0">
                    ...
                    <span className="text-[7.5px] bg-primary/20 text-primary px-1.5 py-0.5 rounded font-mono font-bold border border-primary/20 shrink-0">
                        LVL {level}
                    </span>
                </div>
    ...
    return (
        <Tooltip>
            <TooltipTrigger asChild>
                <div className="flex-1 min-w-[110px] bg-card/35 p-3 rounded-xl border border-border/40 hover:border-primary/40 transition-all duration-300 flex flex-col justify-between items-center text-center relative group hover:bg-card/50">
            ...
            <div className="flex flex-col h-full bg-background/40 rounded-lg overflow-hidden border border-border/50 backdrop-blur-sm">
                ...
                <div className="p-2 px-3 border-b border-border bg-card/30 flex items-center justify-between gap-2.5 shrink-0 select-none">
                    <div className="flex items-center gap-2.5">
                        ...
                        <button
                            ...
                            className="ml-3 px-2 py-0.5 rounded bg-primary/10 border border-primary/20 hover:bg-primary/20 flex items-center gap-1.5 transition-colors font-mono text-[9px] font-bold text-primary uppercase tracking-wider cursor-pointer"
                        >
                ...
                <div className="flex-1 p-3 flex flex-col gap-3 h-full overflow-hidden select-none">
                    ...
                    <div className="flex-1 flex gap-3 min-h-0">
                        ...
                        {/* Skills column */}
                        <div className="flex-1 flex flex-col bg-card/25 border border-border/30 rounded-xl p-3 min-h-0">
                        ...
                        <div className="flex-1 flex flex-col bg-card/25 border border-border/30 rounded-xl p-3 min-h-0">
                            ...
                            <div className="flex-1 flex flex-col justify-between gap-2 min-h-0">
                                {attributes.combatModifiers.map((mod, i) => (
                                    <div key={i} className="flex items-center justify-between p-2 rounded-lg border border-border/40 bg-card/35 hover:bg-card/50 transition-colors gap-2 flex-1">
