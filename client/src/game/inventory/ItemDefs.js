...
export const ItemDefs = {
  ...
  'vehicle.wagon': {
    ...
    attachmentSlots: [
      ...
      { id: 'sleeper', name: 'Wagon Sleeper', allowedItems: ['wagon_sleeper'] },
      { id: 'rc_receiver', name: 'Receiver', allowedItems: ['tool.rc_receiver', 'tool.autonomous_controller'] }
    ],
    disassembleData: {
      toolId: 'weapon.wrench',
  ...
  'vehicle.electric_scooter': {
    ...
    width: 4,
    height: 3,
    traits: [ItemTrait.DRAGGABLE, ItemTrait.VEHICLE, ItemTrait.WAGON, ItemTrait.SCOOTER],
  ...
  'furniture.planter_box': {
    ...
    width: 3,
    height: 3,
    traits: [ItemTrait.DRAGGABLE, ItemTrait.GROUND_ONLY, ItemTrait.CONTAINER, ItemTrait.OPENABLE_WHEN_NESTED, ItemTrait.FURNITURE, ItemTrait.PLANTER],
  ...
  // The one true cure. Used like any other medical consumable (right-click →
  // Use), but unlike brain pulp or brainstem stew — which only pause the virus
  // clock — it clears the infection outright and leaves the player permanently
  // immune. noLoot keeps it out of every generated loot table; it has to be
  // placed deliberately (map editor, quest reward, authored event).
  'medical.zombie_virus_cure': {
    id: 'medical.zombie_virus_cure',
    name: 'Zombie Virus Cure',
    rarity: Rarity.EXTREMELY_RARE,
    imageId: 'zombieVirusCure',
    width: 1,
    height: 1,
    noLoot: true,
    ...
    description: 'A single dose of the zombie virus cure. Clears the infection and leaves you immune to it for good.'
  },
  'medical.stimulant': {
  ...
  'provision.rain_collector': {
    ...
    waterQuality: 'dirty',
    renderFullTile: true,
    traits: [ItemTrait.WATER_CONTAINER, ItemTrait.WATER_SOURCE],
  ...
  'placeable.bed': {
    ...
    noPickup: true,
    renderFullTile: true,
    traits: [ItemTrait.GROUND_ONLY, ItemTrait.DRAGGABLE, ItemTrait.FURNITURE],
    dragApPenalty: 2,
    imageId: 'bed',
    width: 4,
    height: 6,
  ...
  'furniture.generator': {
    ...
    width: 3,
    height: 3,
    traits: [ItemTrait.GROUND_ONLY, ItemTrait.DRAGGABLE, ItemTrait.FUEL_CONTAINER, ItemTrait.POWER_SOURCE, ItemTrait.FURNITURE],
    categories: [ItemCategory.FURNITURE],
    capacity: 50,
    ammoCount: 0,
    isOn: false,
  ...
  'furniture.pharmaceutical_synthesizer': {
    id: 'furniture.pharmaceutical_synthesizer',
    name: 'Pharmaceutical Synthesizer',
    rarity: Rarity.RARE,
    imageId: 'pharmaceuticalSynthesizer',
    backgroundColor: '#8a0303',
    width: 4,
    height: 4,
    traits: [ItemTrait.GROUND_ONLY, ItemTrait.FURNITURE],
    categories: [ItemCategory.FURNITURE, ItemCategory.MEDICAL],
    noDrag: true,
    noPickup: true,
    isPickable: false,
    noLoot: true,
    renderFullTile: true,
    description: 'An advanced pharmaceutical synthesizer for manufacturing medical compounds.'
  },
  'environment.water_puddle': {
    ...
    isPickable: false,
    noDrag: true,
    traits: [ItemTrait.WATER_CONTAINER, ItemTrait.CONSUMABLE, ItemTrait.WATER_SOURCE],
    maxWater: 50,
  ...
  'placeable.stairs_down': {
    id: 'placeable.stairs_down',
    name: 'Stairs Down',
    rarity: Rarity.COMMON,
    imageId: 'stairsdown',
    width: 3,
  ...
  // The one-of-a-kind prize cut from Patient Zero's corpse with a knife (see
  // ZombieCorpseConfig / ActionContext.harvestBrainstem). Never generated by the
  // loot tables — noLoot keeps it out of them. Its art is black on transparent,
  // so it declares its own white backing and opts out of the theme icon filters
  // (fixedAppearance), matching the corpse it came from in every theme.
  'zombie.patient_zero_head': {
    id: 'zombie.patient_zero_head',
    name: 'Patient Zero Head',
    noLoot: true,
    rarity: Rarity.EXTREMELY_RARE,
    imageId: 'patientZeroHead',
    backgroundColor: '#FFFFFF',
    fixedAppearance: true,
    width: 2,
    height: 2,
    categories: [ItemCategory.ENVIRONMENT],
    description: "The severed head of Patient Zero — the source of the outbreak, and the only one there will ever be."
  }
};
