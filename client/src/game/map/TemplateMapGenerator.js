...
import { CorridorGenerator } from './generators/CorridorGenerator.js';
...
export class TemplateMapGenerator {
  ...
  registerGenerators() {
    ...
    this.generators.set('corridor', new CorridorGenerator());
  }
  ...
  loadDefaultTemplates() {
    ...
    // Corridor template - long narrow travel road between towns
    this.templates.set('corridor', {
      name: TEMPLATE_METADATA.corridor.name,
      size: TEMPLATE_METADATA.corridor.size,
      layout: [], // Procedurally generated by CorridorGenerator
      parameters: {
        roadThickness: 5,
        sidewalkThickness: 1
      }
