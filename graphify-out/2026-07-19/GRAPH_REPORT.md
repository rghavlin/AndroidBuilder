...
## Corpus Check
- 549 files · ~5,947,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3473 nodes · 8661 edges · 173 communities (127 shown, 46 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 133 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63dae5c8`
...
Cohesion: 0.11
Nodes (27): EntityFactory, testCornerBug(), testDiagonalBug(), build(), run(), runOscillationTest(), runTest(), testHuntingDoorBug() (+19 more)
...
Cohesion: 0.05
Nodes (37): GameMapProvider(), RabbitAI, getNPCType(), getZombieType(), doorsForBuilding(), floodFill(), PLAYER_FLOOD_OPTS, validateConnectivity() (+29 more)
...
Cohesion: 0.09
Nodes (17): TurretAI, NOTE: equipItem intentionally has NO "Items inside" guard (unlike moveItem)., ItemDefs, EquipmentSlot, FireMode, Rarity, SafeEventEmitter, __dirname (+9 more)
...
Cohesion: 0.04
Nodes (22): AIState, Burnable, Rabbit, SequencerAction, FireSystem, gm, serialized, aiComp (+14 more)
...
Cohesion: 0.06
Nodes (50): CharacterCreatorProps, StatAdjusterCardProps, CharacterRegistryWindow(), CharacterRegistryWindowProps, CreditsWindow(), CreditsWindowProps, DevConsoleProps, TabType (+42 more)
...
Cohesion: 0.09
Nodes (10): PlayerSkills, GameInitializationManager, INIT_STATES, initManager, assert(), verify(), runDebug(), MockMap (+2 more)
...
Cohesion: 0.14
Nodes (9): getProgressionForMap(), LootProgression, MapProgression, computeTollGateLayout(), TOLLGATE_DEFAULTS, AnimalSpawner, NPCSpawner, NOTE: this only PLACES the gate. The turret-firing rules during a toll run (+1 more)
...
Cohesion: 0.03
Nodes (68): JournalUI(), AttributeCard(), AttributeCardProps, CompactSkillRow(), CompactSkillRowProps, SkillProgressBar(), SkillProgressBarProps, AccordionContent (+60 more)
...
Cohesion: 0.33
Nodes (8): ScreenScaler(), ScreenScalerProps, FloatingContainer(), FloatingContainerProps, getScaleFactor(), getScaleMode(), useWindowSize(), WindowSize
...
Cohesion: 0.03
Nodes (40): ActionPoints, AIBehavior, Consumable, EquippedArmor, Health, InventoryContainer, Item, LightEmitter (+32 more)
...
Cohesion: 0.13
Nodes (18): escalateFactionAgainstPlayer(), factionOf(), getAttackableTurretOnTile(), getCarriedPoweredTurret(), getExposedTurretTargets(), getPoweredTurretOnTile(), isPoweredTurret(), NOTE: wagon-nested turrets are not surfaced here yet (they'd need their tile (+10 more)
...
Cohesion: 0.12
Nodes (11): compressString(), decompressString(), DEFAULT_PLAYER_STATS, GameSaveSystem, clear(), getItem(), runTests(), setItem() (+3 more)

### Community 47 - "Game Engine State"
Cohesion: 0.08
Nodes (13): LineOfSight, Quadrant, Row, slope(), map, MockGameMap, map, MockGameMap (+5 more)
...
Cohesion: 0.09
Nodes (21): DamageIntent, DestroyIntent, MoveIntent, NoiseEvent, IntentQueue, NOTE: do NOT force itemsModified for every container/attachment item., AISystem, tryFollowScent() (+13 more)

### Community 62 - "Save Game Management"
Cohesion: 0.09
Nodes (48): DefeatDialog(), EarbucksShopWindow(), GameControls(), GameControlsProps, STAT_COLORS, StatBar, StatBarProps, GameScreenContent() (+40 more)

### Community 64 - "Ground Item Management"
Cohesion: 0.08
Nodes (34): BarterWindow(), BarterWindowProps, InventoryExtensionWindowProps, InventoryPanel(), PlayerSkillsWindowProps, TollWindow(), TollWindowProps, BackpackGrid() (+26 more)
...
Cohesion: 0.05
Nodes (53): InfectionHUD(), drawImprovedCursor(), lastRainUpdate, MapCanvas(), playerRenderScratch, rainParticles, renderRain(), warnedMalformedEntityIds (+45 more)
...
Cohesion: 0.07
Nodes (20): SimulationManager, gm, lead, player, trail, zs, door, gm (+12 more)
...
- **Why does `cn()` connect `Action Queue Processing` to `Shop and Log UI`, `Map Template Generation`, `Character and Menu Windows`, `table.tsx`, `navigation-menu.tsx`, `Combat and Turn Management`, `Sidebar UI Components`, `EventRunner`, `Container Grid Logic`, `Options and Crafting UI`, `Blueprint and Inventory Registry`, `Menubar UI Components`, `Save Game Management`, `Ground Item Management`, `Carousel UI Components`, `Map Tile Logic`, `verify_molotov.mjs`, `context-menu.tsx`, `.getBeltContainers`, `OTP Input Components`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `createItemFromDef()` connect `Table UI Components` to `Item Interaction Logic`, `verify_army_tent.js`, `Shop and Log UI`, `Tooltip Components`, `Entity and Item Types`, `HUD and Dialog UI`, `Entity Spawning and Scent`, `Map Template Generation`, `World Progression and Spawning`, `Door`, `Turret Combat Logic`, `Inventory Management System`, `Map Generation Config`, `Road and Town Generation`, `Line of Sight System`, `Map Editor Tools`, `Crafting Manager Logic`, `Developer Console UI`, `pagination.tsx`, `Inventory Persistence Tests`, `Save Game Management`, `Crafting Recipe Verification`, `Ground Item Management`, `Form UI Components`, `World Object Spawning`, `FurniturePlanner.js`, `Crop Growth Verification`, `Building Hallway Tests`, `Inventory Item Management`, `Starting Road Generation`, `Loot Generation Testing`, `MockMap`?**
