...
## Corpus Check
- 587 files · ~6,402,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3612 nodes · 9182 edges · 193 communities (145 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7eea2490`
...
Cohesion: 0.06
Nodes (23): ItemCategory, RarityWeights, NOTE: do NOT force itemsModified for every container/attachment item., FOOD_SCARCITY, LOOT_CONSTANTS, MAP_WIDE_REQUIREMENTS, SPECIAL_BUILDING_LOOT, ZOMBIE_LOOT (+15 more)
...
Cohesion: 0.09
Nodes (30): DevConsole(), InventoryPanel(), TollWindow(), TollWindowProps, BackpackGrid(), CampfireUI(), ContainerGrid(), ContainerGridProps (+22 more)
...
Cohesion: 0.07
Nodes (10): ActionPoints, Inventory, PlayerSkills, PlayerWallet, Vision, test911(), __dirname, __filename (+2 more)
...
Cohesion: 0.10
Nodes (16): DestroyIntent, NoiseEvent, IntentQueue, AudioSystem, CombatSystem, DestructionSystem, ExplosionSystem, FireSystem (+8 more)
...
Cohesion: 0.04
Nodes (33): AIBehavior, Consumable, EquippedArmor, Health, InventoryContainer, Item, LightEmitter, MeleeWeapon (+25 more)
...
Cohesion: 0.17
Nodes (10): CharacterRegistryWindow(), CharacterRegistryWindowProps, CreditsWindow(), StartMenuProps, CharacterRegistry, clear(), confirm(), setItem() (+2 more)
...
Cohesion: 0.09
Nodes (7): log, NOTE: This only moves the camera view, not any entities, GameInitializationManager, INIT_STATES, EventEmitter, initManager, runDebug()
...
Cohesion: 0.03
Nodes (72): AttributeCard(), AttributeCardProps, CompactSkillRow(), CompactSkillRowProps, SkillProgressBar(), SkillProgressBarProps, ClothingContainerPanel(), AccordionContent (+64 more)
...
Cohesion: 0.13
Nodes (11): findSouthTransitionTile(), computeTollGateLayout(), TOLLGATE_DEFAULTS, NOTE: this only PLACES the gate. The turret-firing rules during a toll run, assert(), verify(), m1, m2 (+3 more)
...
Cohesion: 0.09
Nodes (26): EntityRegistry, GameEvent, QuestRegistry, BubbleEvent, BubbleLine, BUILDING_TYPES, BuildingMeta, createEmptyTile() (+18 more)
...
Cohesion: 0.07
Nodes (11): Rabbit, SequencerAction, gm, serialized, map, mockTile, npc, player (+3 more)
...
Cohesion: 0.08
Nodes (7): Burnable, RpgStats, PlaceIcon, Item, TestEntity, assert(), verify()
...
Cohesion: 0.17
Nodes (20): emptyEntityRegistry(), emptyEvent(), emptyQuestRegistry(), downconvertEvents(), btnStyle(), buildFullItem(), createEmptyGrid(), ENTITY_TYPES (+12 more)

### Community 73 - "World Object Spawning"
Cohesion: 0.05
Nodes (48): BarterWindowProps, ClothingContainerPanelProps, logger, logger, ActionContext, AudioContext, AudioProvider(), CameraContext (+40 more)
...
Cohesion: 0.11
Nodes (11): DamageIntent, MoveIntent, getZombieType(), doorsForBuilding(), PLAYER_FLOOD_OPTS, validateConnectivity(), AISystem, spitAtPlayer() (+3 more)
...
Cohesion: 0.06
Nodes (31): BuildingTooltip(), BuildingTooltipProps, CropTooltip(), CropTooltipProps, DoorTooltip(), DoorTooltipProps, InventoryExtensionWindowProps, JournalUI() (+23 more)
...
Cohesion: 0.13
Nodes (14): getNPCType(), NPCTypes, floodFill(), findAttackSlotPath(), getMeleeReach(), isMeleeAttackPosition(), getBeelineIntent(), getGreedyHuntIntent() (+6 more)
...
Cohesion: 0.24
Nodes (3): AITargeting, debugLog(), TurnManager
...
Cohesion: 0.08
Nodes (21): TurretAI, engine, NOTE: equipItem intentionally has NO "Items inside" guard (unlike moveItem)., _warnedCatchAllProps, getItemName(), ItemDefs, FireMode, getFuelValue() (+13 more)
...
Cohesion: 0.13
Nodes (39): BarterWindow(), EarbucksShopWindow(), GameControls(), GameControlsProps, STAT_COLORS, StatBar, StatBarProps, GameScreenContent() (+31 more)
...
### Community 153 - "test_stacking_bug.mjs"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (21): CategoryDisplayName, CategoryPriority, EquipmentSlot, FUEL_VALUES, ItemTrait, SlotDisplayName, allErrors, generator (+13 more)

### Community 179 - "lineOfSight.test.js"
Cohesion: 0.67
...
- **Why does `cn()` connect `Action Queue Processing` to `Game Engine Context`, `AI and Inventory Systems`, `chart.tsx`, `command.tsx`, `Inventory and Skill Windows`, `Entity Spawning and Scent`, `Character and Menu Windows`, `table.tsx`, `navigation-menu.tsx`, `Sidebar UI Components`, `EventRunner`, `ImageLoader`, `Menubar UI Components`, `MapBuilder.js`, `Form UI Components`, `World Object Spawning`, `Command UI Components`, `Item Stacking Verification`, `.generateNextMap`, `OTP Input Components`, `table.tsx`?**
...
- **Why does `react` connect `react` to `Dialog and Button UI`, `World Object Spawning`, `.generateNextMap`, `External Dependencies`, `MockCtx`, `verify_crop_rendering.js`, `table.tsx`?**
