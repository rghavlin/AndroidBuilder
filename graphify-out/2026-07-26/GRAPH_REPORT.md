...
## Corpus Check
- 586 files · ~6,401,707 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3609 nodes · 9177 edges · 176 communities (131 shown, 45 thin omitted)
...
Cohesion: 0.03
Nodes (50): ActionPoints, AIBehavior, AIState, Burnable, Consumable, EquippedArmor, Health, Inventory (+42 more)
...
Cohesion: 0.12
Nodes (6): BaseMapGenerator, gameRandom, makeSeededRandom(), brokenScopeStats, templates, tmg
...
Cohesion: 0.07
Nodes (20): engine, INIT_STATES, SimulationManager, NOTE: Structural damage (hp reduction, break/open flags) was already, applyNpcAIMode(), log, ZombieSpawner, door (+12 more)
...
Cohesion: 0.06
Nodes (57): GameControls(), GameControlsProps, STAT_COLORS, StatBar, StatBarProps, GameScreenContent(), InfectionHUD(), MapTransitionDialog() (+49 more)
...
Cohesion: 0.08
Nodes (15): Item, MeleeWeapon, getSightRangeForHour(), EntityType, NOTE: do NOT force itemsModified for every container/attachment item., LineOfSight, logger, Pathfinding (+7 more)
...
Cohesion: 0.11
Nodes (28): BarterWindow(), DevConsole(), EarbucksShopWindow(), MapInterface(), TileTooltipOverlay(), CampfireUI(), CampfireUIProps, CraftingUI() (+20 more)
...
Cohesion: 0.07
Nodes (35): EntityFactory, testCornerBug(), testDiagonalBug(), build(), run(), runOscillationTest(), testHuntingDoorBug(), testWindowOscillations() (+27 more)
...
- **Why does `cn()` connect `Action Queue Processing` to `Game Engine Context`, `AI and Inventory Systems`, `Inventory and Skill Windows`, `HUD and Dialog UI`, `Entity Spawning and Scent`, `Character and Menu Windows`, `table.tsx`, `navigation-menu.tsx`, `Sidebar UI Components`, `EventRunner`, `Dialog and Button UI`, `ImageLoader`, `Menubar UI Components`, `MapBuilder.js`, `Form UI Components`, `Toast Notification State`, `World Object Spawning`, `Command UI Components`, `OTP Input Components`, `table.tsx`?**
...
- **Why does `react` connect `EventRunner` to `Dialog and Button UI`, `Toast Notification State`, `World Object Spawning`, `External Dependencies`, `Sidebar UI Components`, `verify_crop_rendering.js`, `table.tsx`?**
