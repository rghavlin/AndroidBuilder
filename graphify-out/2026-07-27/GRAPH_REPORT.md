...
## Corpus Check
- 597 files · ~6,750,235 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3653 nodes · 9334 edges · 176 communities (132 shown, 44 thin omitted)
...
- `buildPlanGrid()` --calls--> `makeLayoutGrid()`  [EXTRACTED]
  test/map/floorplanRegistry.test.js → client/src/game/map/RoomGraph.js
- `buildPlanGrid()` --calls--> `makeLayoutGrid()`  [EXTRACTED]
  tmp/check_furniture_violations.mjs → client/src/game/map/RoomGraph.js
...
Cohesion: 0.05
Nodes (46): ARCHETYPES, BUNGALOW_2BED_LARGE, BUNGALOW_2BED_WIDE, BUNGALOW_3BED_EXTRA_WIDE, BUNGALOW_3BED_WIDE, BY_SIZE, CENTER_HALL_12, CENTER_HALL_14 (+38 more)

### Community 3 - "Game Engine Context"
Cohesion: 0.03
Nodes (76): AttributeCard(), CompactSkillRow(), SkillProgressBar(), TradeDialog(), TradeDialogProps, AttachmentSlot, AttachmentSlotProps, FloatingContainerOverlayProps (+68 more)

### Community 4 - "AI and Inventory Systems"
Cohesion: 0.09
Nodes (37): BarterWindow(), BarterWindowProps, InventoryExtensionWindowProps, InventoryPanel(), NPCDemandDialog(), PlayerSkillsWindowProps, TollWindow(), TollWindowProps (+29 more)
...
Cohesion: 0.07
Nodes (20): AIBehavior, Health, InventoryContainer, LightEmitter, Movable, Renderable, aiCustom, aiDefault (+12 more)
...
Cohesion: 0.07
Nodes (19): DamageIntent, DestroyIntent, MoveIntent, NoiseEvent, Position, IntentQueue, AISystem, AudioSystem (+11 more)
...
Cohesion: 0.04
Nodes (22): isSpecialBuilding(), doorsForBuilding(), PLAYER_FLOOD_OPTS, validateConnectivity(), isInsideCompound(), NOTE: previously spawned a 'placeable.help' ("?") item on every legacy, TemplateMapGenerator, ASSERT_FURNISHED (+14 more)
...
Cohesion: 0.11
Nodes (21): MapTransitionDialog(), MapTransitionDialogProps, NPCDemandDialogProps, TutorialEndDialog(), TutorialEndDialogProps, Command, CommandEmpty, CommandGroup (+13 more)
...
Cohesion: 0.17
Nodes (19): markHeardIfInRange(), testCornerBug(), testDiagonalBug(), build(), run(), runOscillationTest(), testHuntingDoorBug(), main() (+11 more)
...
Cohesion: 0.08
Nodes (42): CharacterCreatorProps, StatAdjusterCardProps, CharacterRegistryWindow(), CharacterRegistryWindowProps, CreditsWindow(), CreditsWindowProps, DefeatDialog(), HelpWindow() (+34 more)
...
Cohesion: 0.10
Nodes (8): BuildingTypes, SPECIAL_BUILDING_SPECS, BaseMapGenerator, SplitRoadGenerator, deriveRoadBands(), gameRandom, makeSeededRandom(), brokenScopeStats
...
### Community 23 - "Door"
Cohesion: 0.19
Nodes (10): CraftingRecipes, runVerification(), assert(), verify(), isUncommonDrop, recipe, verifyMolotov(), runTest() (+2 more)

### Community 24 - "Turret Combat Logic"
Cohesion: 0.05
Nodes (23): Rabbit, gm, serialized, actionQueue, activeZombie, diedAny, ecsEntities, explosionIntent (+15 more)
...
Cohesion: 0.05
Nodes (85): BuildingTooltip(), BuildingTooltipProps, CropTooltip(), CropTooltipProps, DoorTooltip(), DoorTooltipProps, GameControls(), GameControlsProps (+77 more)
...
Cohesion: 0.14
Nodes (9): formatTimestamp(), SaveGameWindow(), StartMenu(), IndexedDBStore, clear(), confirm(), setItem(), store (+1 more)
...
Cohesion: 0.08
Nodes (45): emptyEntityRegistry(), emptyEvent(), emptyQuestRegistry(), EntityRegistry, GameEvent, QuestRegistry, btnStyle(), BubbleEvent (+37 more)
...
Cohesion: 0.17
Nodes (9): GameContextInner(), compressString(), decompressString(), DEFAULT_PLAYER_STATS, GameSaveSystem, idbStore, runTest(), assert() (+1 more)
...
Cohesion: 0.21
Nodes (6): PlayerProvider(), getEffectiveHour(), getLightMode(), getSightRangeForHour(), isNightHour(), log
...
Cohesion: 0.04
Nodes (24): ActionPoints, AIState, Burnable, Consumable, EquippedArmor, Item, MeleeWeapon, RpgStats (+16 more)
...
Cohesion: 0.06
Nodes (30): AITargeting, TurretAI, EntityType, engine, SimulationManager, NOTE: Structural damage (hp reduction, break/open flags) was already, computeHearingZone(), door (+22 more)
...
Cohesion: 0.12
Nodes (9): DevConsole(), CameraProvider(), ScenarioMapGenerator, exportScenario(), main(), runTests(), MockGameMap, testWallGapFix() (+1 more)

### Community 75 - "Map Serialization Tests"
Cohesion: 0.10
Nodes (14): createItemFromDef(), getFoodRejectionChance(), LootGenerator, isInsideAnyBuilding(), isFloor(), applyItemGrants(), testCharger(), assert() (+6 more)
...
Cohesion: 0.07
Nodes (36): MAP_GEN_CONFIG, clearOfOccupied(), contactSides(), footprintPlaceable(), FURNISH_PLAN, FURNITURE_FOOTPRINTS, HEAD_SIDE, planFurniture() (+28 more)
...
Cohesion: 0.08
Nodes (20): dropZombieDeathLoot(), getBrainstemColor(), getBrainstemStewColors(), getCorpseOverrides(), ZombieCorpseConfig, CraftingManager, getItemName(), getFuelValue() (+12 more)
...
Cohesion: 0.08
Nodes (14): NPCTypes, engine, NOTE: equipItem intentionally has NO "Items inside" guard (unlike moveItem)., ItemDefs, EquipmentSlot, FireMode, Rarity, SafeEventEmitter (+6 more)
...
Cohesion: 0.05
Nodes (9): GameMap, NOTE: do NOT force itemsModified for every container/attachment item., map, player, tracker, zombie, emptyTiles(), loadScenario() (+1 more)
...
Cohesion: 0.18
Nodes (5): logger, Quadrant, slope(), map, MockGameMap
...
Cohesion: 0.20
Nodes (16): escalateFactionAgainstPlayer(), factionOf(), getAttackableTurretOnTile(), getCarriedPoweredTurret(), getExposedTurretTargets(), getPoweredTurretOnTile(), isPoweredTurret(), isTurretPassableBy() (+8 more)
...
Cohesion: 0.06
Nodes (29): Inventory, PlayerSkills, PlayerWallet, EntityFactory, INIT_STATES, testWindowOscillations(), testWindowBug(), testZombieBug() (+21 more)
...
- **Why does `cn()` connect `Game Engine Context` to `chart.tsx`, `AI and Inventory Systems`, `Shop and Log UI`, `HUD and Dialog UI`, `Character and Menu Windows`, `table.tsx`, `Action Queue Processing`, `navigation-menu.tsx`, `Sidebar UI Components`, `EventRunner`, `Container Grid Logic`, `Dialog and Button UI`, `Menubar UI Components`, `Item Stacking Verification`, `MockCtx`, `EarbucksShopSystem`, `SurvivalCascade.js`, `tmp_verify_zombie_loot.js`, `OTP Input Components`?**
...
- **Why does `react` connect `chart.tsx` to `Container Grid Logic`, `Form UI Components`, `Dialog and Button UI`, `External Dependencies`, `Action Queue Processing`, `OTP Input Components`, `Sidebar UI Components`?**
...
- **Should `Game Engine Context` be split into smaller, more focused modules?**
  _Cohesion score 0.030059746079163556 - nodes in this community are weakly interconnected._