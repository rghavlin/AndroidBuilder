...
## Corpus Check
- 558 files · ~10,006,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3534 nodes · 8831 edges · 194 communities (138 shown, 56 thin omitted)
...
## Communities (194 total, 56 thin omitted)

### Community 0 - "Item Components"
Cohesion: 0.05
Nodes (21): EntityType, NPCTypes, GameMap, NOTE: do NOT force itemsModified for every container/attachment item., logger, Pathfinding, runTest(), map (+13 more)
...
Cohesion: 0.10
Nodes (26): JournalUI(), MainMenuWindow(), MainMenuWindowProps, MapTransitionDialog(), MapTransitionDialogProps, NPCDemandDialog(), NPCDemandDialogProps, TutorialEndDialog() (+18 more)
...
Cohesion: 0.15
Nodes (6): createItemFromDef(), getFoodRejectionChance(), LootGenerator, isInsideAnyBuilding(), assert(), verify()

### Community 9 - "Entity Component System"
Cohesion: 0.07
Nodes (4): COMPONENT_NAME_BY_CTOR, Entity, get(), set()
...
Cohesion: 0.09
Nodes (26): drawImprovedCursor(), lastRainUpdate, MapCanvas(), playerRenderScratch, rainParticles, renderRain(), warnedMalformedEntityIds, SpeechBubbleInput() (+18 more)

### Community 14 - "Rabbit AI State"
Cohesion: 0.05
Nodes (22): AIState, Rabbit, SequencerAction, FireSystem, AnimalSpawner, gm, serialized, aiComp (+14 more)
...
Cohesion: 0.06
Nodes (49): ActionSlotButton(), ActionSlotButtonProps, EarbucksDisplay(), EarbucksShopWindowProps, ShopItemRow(), ShopItemRowProps, GameEventLog(), GameEventLogProps (+41 more)

### Community 19 - "Character and Menu Windows"
Cohesion: 0.09
Nodes (24): CharacterCreatorProps, StatAdjusterCardProps, CharacterRegistryWindow(), CharacterRegistryWindowProps, CreditsWindow(), CreditsWindowProps, DevConsoleProps, TabType (+16 more)
...
### Community 23 - "Door"
Cohesion: 0.06
Nodes (26): DestroyIntent, MoveIntent, NoiseEvent, AudioSystem, DestructionSystem, mockEngine, actionQueue, activeZombie (+18 more)

### Community 24 - "Turret Combat Logic"
Cohesion: 0.12
Nodes (10): getProgressionForMap(), LootProgression, MapProgression, findSouthTransitionTile(), computeTollGateLayout(), TOLLGATE_DEFAULTS, NPCSpawner, NOTE: this only PLACES the gate. The turret-firing rules during a toll run (+2 more)

### Community 25 - "Inventory Management System"
Cohesion: 0.05
Nodes (15): hasItemsInside(), InventoryManager, isClothingOrBackpack(), runContainerTests(), run(), run(), testSerialization(), runTest() (+7 more)
...
Cohesion: 0.15
Nodes (8): OptionsWindow(), StartMenu(), IndexedDBStore, clear(), confirm(), setItem(), store, testRegistry()
...
Cohesion: 0.25
Nodes (13): escalateFactionAgainstPlayer(), factionOf(), getAttackableTurretOnTile(), getCarriedPoweredTurret(), getExposedTurretTargets(), getPoweredTurretOnTile(), isPoweredTurret(), provokeTargetFaction() (+5 more)
...
Cohesion: 0.11
Nodes (12): getBrainstemColor(), getBrainstemStewColors(), CraftingManager, cm, container, inContainer, mockInv, singleItem (+4 more)
...
Cohesion: 0.10
Nodes (14): compressString(), decompressString(), DEFAULT_PLAYER_STATS, GameSaveSystem, idbStore, runTest(), Logger, clear() (+6 more)

### Community 47 - "Game Engine State"
Cohesion: 0.15
Nodes (8): LineOfSight, Quadrant, Row, slope(), main(), main(), main(), test()
...
Cohesion: 0.04
Nodes (37): ActionPoints, AIBehavior, Burnable, Consumable, EquippedArmor, Health, InventoryContainer, Item (+29 more)
...
Cohesion: 0.11
Nodes (14): DamageIntent, IntentQueue, AISystem, tryFollowScent(), CombatSystem, ExplosionSystem, MovementSystem, VisionSystem (+6 more)

### Community 62 - "Save Game Management"
Cohesion: 0.06
Nodes (79): DefeatDialog(), EarbucksShopWindow(), GameControls(), GameControlsProps, STAT_COLORS, StatBar, StatBarProps, GameScreenContent() (+71 more)

### Community 64 - "Ground Item Management"
Cohesion: 0.10
Nodes (24): BarterWindow(), BarterWindowProps, InventoryExtensionWindowProps, InventoryPanel(), PlayerSkillsWindowProps, TollWindow(), TollWindowProps, BackpackGrid() (+16 more)
...
Cohesion: 0.14
Nodes (8): hashLocation(), hashNavigate(), useHashLocation(), ScreenScaler(), ScreenScalerProps, ThemeProvider(), ErrorBoundary, GamePage()
...
Cohesion: 0.08
Nodes (22): getSightRangeForHour(), INIT_STATES, LAYOUT, isInsideTollGate(), isInStartArea(), NOTE: previously spawned a 'placeable.help' ("?") item on every legacy, NOTE: tile-fire ticking lives on GameMap.processTileFires(), which iterates, logger (+14 more)
...
Cohesion: 0.29
Nodes (6): MAP_GEN_CONFIG, BuildingTypes, isSpecialBuilding(), SPECIAL_BUILDING_SPECS, assert(), verify()
...
Cohesion: 0.07
Nodes (27): NOTE: equipItem intentionally has NO "Items inside" guard (unlike moveItem)., _warnedCatchAllProps, getItemName(), ItemDefs, testResults, CategoryDisplayName, CategoryPriority, EquipmentSlot (+19 more)
...
Cohesion: 0.36
Nodes (4): DevConsole(), main(), testWallGapFix(), verifyRestoration()
...
Cohesion: 0.09
Nodes (32): EntityFactory, addPlayer(), testCornerBug(), testDiagonalBug(), build(), run(), runOscillationTest(), testHuntingDoorBug() (+24 more)
...
Cohesion: 0.05
Nodes (33): engine, SimulationManager, NOTE: Structural damage (hp reduction, break/open flags) was already, gm, lead, player, trail, zs (+25 more)
...
- **Why does `cn()` connect `Action Queue Processing` to `Action Intent System`, `Shop and Log UI`, `Inventory and Skill Windows`, `Map Template Generation`, `Character and Menu Windows`, `table.tsx`, `navigation-menu.tsx`, `Combat and Turn Management`, `Sidebar UI Components`, `EventRunner`, `Blueprint and Inventory Registry`, `Menubar UI Components`, `Save Game Management`, `Ground Item Management`, `Carousel UI Components`, `Map Tile Logic`, `context-menu.tsx`, `Registry Storage Tests`, `Seeded Random Utilities`, `Safe Grid Data Testing`, `OTP Input Components`?**
...
- **Why does `createItemFromDef()` connect `Tooltip Components` to `Item Components`, `Item Interaction Logic`, `Shop and Log UI`, `Entity and Item Types`, `HUD and Dialog UI`, `Entity Spawning and Scent`, `Map Template Generation`, `World Progression and Spawning`, `Door`, `Turret Combat Logic`, `Inventory Management System`, `Map Generation Config`, `Road and Town Generation`, `Map Editor Tools`, `Crafting Manager Logic`, `Developer Console UI`, `Entity Serialization Tests`, `.dropScent`, `Inventory Persistence Tests`, `Save Game Management`, `Crafting Recipe Verification`, `World Object Spawning`, `Map Serialization Tests`, `App Routing and Scaling`, `FurniturePlanner.js`, `Crop Growth Verification`, `Building Hallway Tests`, `Table UI Components`, `Inventory Item Management`, `Starting Road Generation`, `Book Stats Initialization`, `Consumable`, `EquippedArmor`?**
