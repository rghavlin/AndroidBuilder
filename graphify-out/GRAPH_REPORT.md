...
## Corpus Check
- 537 files · ~5,923,748 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3371 nodes · 8421 edges · 168 communities (124 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 126 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74129d9c`
...
Cohesion: 0.05
Nodes (27): LootProgression, RarityWeights, FOOD_SCARCITY, getFoodRejectionChance(), LOOT_CONSTANTS, LootGenerator, MAP_WIDE_REQUIREMENTS, MAP_WIDE_UNIQUES (+19 more)
...
Cohesion: 0.06
Nodes (29): TurretAI, NOTE: equipItem intentionally has NO "Items inside" guard (unlike moveItem)., _warnedCatchAllProps, createItemFromDef(), ItemDefs, FireMode, applyItemGrants(), __dirname (+21 more)
...
Cohesion: 0.04
Nodes (29): Rabbit, gm, serialized, map, mockTile, npc, player, rabbit (+21 more)

### Community 15 - "HUD and Dialog UI"
Cohesion: 0.03
Nodes (48): ActionPoints, AIBehavior, AIState, Burnable, Consumable, EquippedArmor, Health, Inventory (+40 more)
...
Cohesion: 0.06
Nodes (12): MAP_GEN_CONFIG, BuildingTypes, isSpecialBuilding(), isInsideCompound(), NOTE: previously spawned a 'placeable.help' ("?") item on every legacy, TemplateMapGenerator, isInsideBuilding(), verifyMap4() (+4 more)

### Community 19 - "Character and Menu Windows"
Cohesion: 0.08
Nodes (38): CharacterCreatorProps, StatAdjusterCardProps, CharacterRegistryWindowProps, CreditsWindow(), CreditsWindowProps, DevConsoleProps, TabType, HelpWindow() (+30 more)
...
Cohesion: 0.11
Nodes (16): DevConsoleShopManager(), CATEGORY_PRICES, field(), FLAT_PRICES, FREE_ITEMS, getItemPrice(), hasCategory(), hasTrait() (+8 more)
...
Cohesion: 0.03
Nodes (80): ActionSlotButtonProps, EarbucksShopWindowProps, ShopItemRow(), ShopItemRowProps, TradeDialog(), TradeDialogProps, ZombieTooltip(), ZombieTooltipProps (+72 more)
...
Cohesion: 0.19
Nodes (4): getBrainstemColor(), getBrainstemStewColors(), CraftingManager, getItemName()
...
Cohesion: 0.10
Nodes (10): LineOfSight, Quadrant, Row, slope(), map, MockGameMap, main(), main() (+2 more)
...
Cohesion: 0.09
Nodes (22): ActionSlotButton(), EarbucksDisplay(), GameEventLog(), GameEventLogProps, getLogColor(), formatTimestamp(), LoadGameWindow(), getLogColor() (+14 more)
...
Cohesion: 0.14
Nodes (17): drawImprovedCursor(), lastRainUpdate, MapCanvas(), playerRenderScratch, rainParticles, renderRain(), warnedMalformedEntityIds, SpeechBubbleInput() (+9 more)
...
Cohesion: 0.11
Nodes (5): BaseMapGenerator, ScenarioMapGenerator, deriveRoadBands(), WindingRoadGenerator, makeSeededRandom()
...
Cohesion: 0.08
Nodes (37): BarterWindow(), BarterWindowProps, InventoryExtensionWindowProps, InventoryPanel(), PlayerSkillsWindowProps, TollWindow(), TollWindowProps, AttachmentSlot (+29 more)

### Community 65 - "Scenario Map Generation"
Cohesion: 0.09
Nodes (23): FloatingContainerOverlay(), FloatingContainerOverlayProps, GridSlot, GridSlotProps, ItemContextMenu(), ItemContextMenuProps, getAdjustedBgColor(), UniversalGrid() (+15 more)
...
Cohesion: 0.09
Nodes (20): DamageIntent, DestroyIntent, NoiseEvent, IntentQueue, AISystem, AudioSystem, CombatSystem, DestructionSystem (+12 more)
...
Cohesion: 0.09
Nodes (8): WorldManager, assert(), verify(), entities, wm, wm2, zombies, runDebug()
...
Cohesion: 0.14
Nodes (14): BlueprintRegistry, createAmmo(), createArmor(), createAttachment(), createClothing(), createFood(), createItem(), createMedical() (+6 more)
...
Cohesion: 0.08
Nodes (28): DevConsole(), AttributeCard(), AttributeCardProps, CompactSkillRow(), CompactSkillRowProps, SkillProgressBar(), SkillProgressBarProps, CameraProvider() (+20 more)
...
Cohesion: 0.05
Nodes (83): BuildingTooltip(), BuildingTooltipProps, CropTooltip(), CropTooltipProps, DoorTooltip(), DoorTooltipProps, EarbucksShopWindow(), GameControls() (+75 more)
...
Cohesion: 0.06
Nodes (23): log, getProgressionForMap(), MapProgression, getSightRangeForHour(), engine, INIT_STATES, NOTE: Structural damage (hp reduction, break/open flags) was already, log (+15 more)

### Community 157 - "command.tsx"
Cohesion: 0.08
Nodes (27): DefeatDialog(), DialogOverlayProps, DialogStep, JournalUI(), MapTransitionDialog(), MapTransitionDialogProps, NPCDemandDialog(), NPCDemandDialogProps (+19 more)
...
Cohesion: 0.07
Nodes (17): Item, MeleeWeapon, MoveIntent, EntityType, NPCTypes, NOTE: do NOT force itemsModified for every container/attachment item., Pathfinding, runTest() (+9 more)

### Community 175 - "verify_bookstats_init_derived.mjs"
Cohesion: 0.06
Nodes (34): CraftingRecipes, testResults, CategoryDisplayName, CategoryPriority, EquipmentSlot, FUEL_VALUES, getFuelValue(), ItemCategory (+26 more)
...
- **Why does `cn()` connect `Action Queue Processing` to `Ground Item Management`, `Scenario Map Generation`, `verify_army_tent.js`, `Toast Notification State`, `navigation-menu.tsx`, `Blueprint and Inventory Registry`, `Sidebar UI Components`, `Character and Menu Windows`, `Book Stats Initialization`, `context-menu.tsx`, `World Progression and Spawning`, `EquippedArmor`, `Menubar UI Components`, `navigation-menu.tsx`, `table.tsx`, `OTP Input Components`, `command.tsx`?**
...
- **Why does `react` connect `MinHeap` to `verify_army_tent.js`, `Toast Notification State`, `External Dependencies`, `Blueprint and Inventory Registry`, `Entity Serialization Tests`, `Save Game Management`?**
