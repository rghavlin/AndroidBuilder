...
## Corpus Check
- 541 files · ~5,931,087 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3408 nodes · 8523 edges · 183 communities (123 shown, 60 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5533a34`
...
Cohesion: 0.06
Nodes (31): NOTE: equipItem intentionally has NO "Items inside" guard (unlike moveItem)., _warnedCatchAllProps, ItemDefs, CategoryDisplayName, CategoryPriority, EquipmentSlot, FireMode, FUEL_VALUES (+23 more)
...
Cohesion: 0.05
Nodes (21): DevConsole(), AIState, Rabbit, SequencerAction, gm, serialized, aiComp, ent (+13 more)
...
Cohesion: 0.07
Nodes (16): door, doorNoTag, entityMap, MockEntity, officerBob, player, resBob, resDoor (+8 more)

### Community 18 - "Map Template Generation"
Cohesion: 0.06
Nodes (11): MAP_GEN_CONFIG, BuildingTypes, isSpecialBuilding(), isInsideCompound(), NOTE: previously spawned a 'placeable.help' ("?") item on every legacy, TemplateMapGenerator, isInsideBuilding(), verifyMap4() (+3 more)

### Community 19 - "Character and Menu Windows"
Cohesion: 0.08
Nodes (41): CharacterCreatorProps, StatAdjusterCardProps, CharacterRegistryWindowProps, CreditsWindow(), CreditsWindowProps, DefeatDialog(), DevConsoleProps, TabType (+33 more)
...
Cohesion: 0.03
Nodes (78): JournalUI(), TradeDialog(), TradeDialogProps, GridSlot, GridSlotProps, ItemTooltip(), ItemTooltipProps, WorkspaceSlot (+70 more)
...
Cohesion: 0.19
Nodes (8): INIT_STATES, isInsideTollGate(), isInStartArea(), logger, ZombieReplenishmentSystem, ZombieSpawner, buildings, runVerification()
...
Cohesion: 0.07
Nodes (31): dropZombieDeathLoot(), getCorpseOverrides(), ZombieCorpseConfig, engine, createItemFromDef(), SimulationManager, NOTE: Structural damage (hp reduction, break/open flags) was already, DestructionSystem (+23 more)
...
Cohesion: 0.07
Nodes (51): BarterWindow(), BarterWindowProps, InventoryExtensionWindowProps, InventoryPanel(), TollWindow(), TollWindowProps, AttachmentSlot, AttachmentSlotProps (+43 more)

### Community 65 - "Scenario Map Generation"
Cohesion: 0.10
Nodes (28): ActionSlotButton(), ActionSlotButtonProps, EarbucksDisplay(), EarbucksShopWindowProps, ShopItemRow(), ShopItemRowProps, GameEventLog(), GameEventLogProps (+20 more)
...
Cohesion: 0.08
Nodes (17): AIBehavior, DamageIntent, DestroyIntent, MoveIntent, NoiseEvent, IntentQueue, AISystem, AudioSystem (+9 more)
...
Cohesion: 0.12
Nodes (13): getProgressionForMap(), LootProgression, MapProgression, findSouthTransitionTile(), computeTollGateLayout(), TOLLGATE_DEFAULTS, AnimalSpawner, NPCSpawner (+5 more)
...
Cohesion: 0.23
Nodes (13): resolveTileTarget(), escalateFactionAgainstPlayer(), factionOf(), getAttackableTurretOnTile(), getCarriedPoweredTurret(), getExposedTurretTargets(), getPoweredTurretOnTile(), isPoweredTurret() (+5 more)
...
Cohesion: 0.09
Nodes (17): OptionsWindow(), StartMenu(), compressString(), decompressString(), DEFAULT_PLAYER_STATS, GameSaveSystem, idbStore, IndexedDBStore (+9 more)
...
Cohesion: 0.14
Nodes (7): makeLayoutGrid(), exportScenario(), main(), assert(), verify(), MockGameMap, testWallGapFix()
...
Cohesion: 0.11
Nodes (17): AttributeCard(), AttributeCardProps, CompactSkillRow(), CompactSkillRowProps, SkillProgressBar(), SkillProgressBarProps, PlayerSkillsWindowProps, AttributeProgressionManager (+9 more)
...
Cohesion: 0.05
Nodes (95): CropTooltip(), CropTooltipProps, DoorTooltip(), DoorTooltipProps, EarbucksShopWindow(), GameControls(), GameControlsProps, STAT_COLORS (+87 more)
...
### Community 171 - "Logger"
Cohesion: 0.16
Nodes (7): log, LOG_LEVELS, Logger, map, player, tracker, zombie

### Community 173 - "Pathfinding.js"
Cohesion: 0.11
Nodes (10): Item, MeleeWeapon, EntityType, NPCTypes, NOTE: do NOT force itemsModified for every container/attachment item., findAttackSlotPath(), isMeleeAttackPosition(), Pathfinding (+2 more)
...
## Knowledge Gaps
- **872 isolated node(s):** `inputContent`, `ActionSlotButtonProps`, `BarterWindowProps`, `BuildingTooltipProps`, `CharacterCreatorProps` (+867 more)
...
- **Why does `cn()` connect `Action Queue Processing` to `AI and Inventory Systems`, `verify_army_tent.js`, `verify_transition_from_map_id.mjs`, `Character and Menu Windows`, `World Progression and Spawning`, `table.tsx`, `useGame`, `navigation-menu.tsx`, `Sidebar UI Components`, `Blueprint and Inventory Registry`, `Menubar UI Components`, `Ground Item Management`, `Scenario Map Generation`, `context-menu.tsx`, `Safe Grid Data Testing`, `Book Stats Initialization`, `SurvivalCascade.js`, `.getBeltContainers`, `OTP Input Components`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `createItemFromDef()` connect `pagination.tsx` to `Item Interaction Logic`, `AI and Inventory Systems`, `verify_army_tent.js`, `Shop and Log UI`, `Tooltip Components`, `Map Template Generation`, `Turret Combat Logic`, `Inventory Management System`, `Map Generation Config`, `Options and Crafting UI`, `Road and Town Generation`, `Map Editor Tools`, `Crafting Manager Logic`, `Pathfinding.js`, `Entity Serialization Tests`, `Crafting Recipe Verification`, `Ground Item Management`, `Carousel UI Components`, `World Object Spawning`, `.executeTransition`, `verify_molotov.mjs`, `FurniturePlanner.js`, `Crop Growth Verification`, `DevConsole.tsx`, `Building Hallway Tests`, `Starting Road Generation`, `Seeded Random Utilities`, `navigation-menu.tsx`, `table.tsx`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Registry Storage Tests`, `verify_army_tent.js`, `External Dependencies`, `Safe Grid Data Testing`, `Save Game Management`?**
